...
describe("Create Device Use Case", () => {
  ...
  test("should return true", async () => {
    ...
    jest
      .spyOn(mockDeviceRepository, "createDevice")
      .mockImplementation(() => Promise.resolve(true));
    const createDeviceUseCase = new CreateDevice(mockDeviceRepository);
    const result = await createDeviceUseCase.execute(InputData);
